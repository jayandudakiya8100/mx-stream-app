...
import 'package:mxstream/moviesPage/UI/iran_movie_watch_page.dart';
...
import 'package:mxstream/functions/fetchers/providers/provider_manager.dart';
import 'package:mxstream/functions/fetchers/providers/VegaMovies/old_vega_movies_provider.dart';
import 'package:mxstream/player/temp_player_sheet.dart';
import 'package:mxstream/player/custom_video_player.dart';
import 'dart:convert';
...
class _WatchOptionsContentState extends State<_WatchOptionsContent> {
  ...
  Widget _buildWebDirectLinkButtons() {
    final links = {
      'Berlin Server':
          'https://berlin.saymyname.website/Movies/${widget.year}/${widget.imdbIdWithoutTT}',
      'Tokyo Server':
          'https://tokyo.saymyname.website/Movies/${widget.year}/${widget.imdbIdWithoutTT}',
      'Nairobi Server':
          'https://nairobi.saymyname.website/Movies/${widget.year}/${widget.imdbIdWithoutTT}',
    };
                      ...
                      return ListTile(
                        leading: Container(
                          ...
                          child: Icon(Icons.play_circle_fill,
                              color: widget.mainColor, size: 22),
                        ),
                        title: Text(
                          stream.quality,
                          style: const TextStyle(
                        ...
                        trailing: Row(
                          ...
                          children: [
                            IconButton(
                              ...
                              tooltip: 'Copy URL',
                              onPressed: () =>
                                  _copyToClipboard(context, stream.streamUrl),
                            ),
                            IconButton(
                              icon: Icon(Icons.play_arrow_rounded,
                                  color: widget.mainColor, size: 26),
                              tooltip: 'Play Movie',
                              onPressed: () {
                                Navigator.of(context).pop();
